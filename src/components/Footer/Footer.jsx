...
import logoO from '../../assets/img/logo-o.svg';
        ...
        <footer className={styles.footer}>
            <Container>
                <div className={styles.footer__content}>
                    <img className={styles.footer__logo} src={logoO} alt="Логотип YourMeal" />
                    ...
                    <address className={styles.footer__address}>
                        ...
                        <div className={styles.footer__contact}>
                            <h2 className={classNames(styles.footer__title, styles.footer__title_sn)}>Мы в соцсетях</h2>
                    ...
                    <div className={styles.footer__development}>
                        <p>© YouMeal, 2022</p>
                        <p>Design: <a href="#">Anastasia Ilina</a>
                        </p>
                        <p>Developer: <a href="mailto:maksim.leskin@methed.ru">Maksim Leskin</a>
                        </p>
                    </div>
                </div>
            </Container>
